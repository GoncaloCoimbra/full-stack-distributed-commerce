    ...
    <div className="min-h-screen flex flex-col bg-slate-950">
      <header className="bg-slate-900/90 px-6 py-4 flex items-center justify-between border-b border-slate-700">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm">Administrator Area</p>
          </div>
        </div>
      ...
      <main className="flex-1 bg-slate-950 py-8 px-4 sm:px-6 lg:px-8"> 
        ...
        <p className="text-slate-300">
          Use the side menu to navigate — the main dashboard is already available at <a className="text-red-400 underline" href="/dashboard">/dashboard</a>.
        </p>
      </main>
    </div>
  );
